...
module Backend
  module Generators
    class ScaffoldGenerator < Rails::Generators::NamedBase
      ...
      def copy_files
        directory "erb", "app/views/backend/#{file_name.pluralize}"

        template "controller.rb", "app/controllers/backend/#{controller_file_name}_controller.rb"

        template "functional_test.rb", "test/controllers/backend/#{controller_file_name}_controller_test.rb"
        template "system_test.rb",     "test/system/backend/#{file_name.pluralize}_test.rb"
      end

      def create_routes
        route "resources :#{file_name.pluralize}", namespace: :backend
      end
